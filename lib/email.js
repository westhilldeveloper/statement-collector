    ...
    const mailOptions = {
      ...
      html: `
        ...
        <body>
          <div class="container">
            <div class="header">
             <img src="https://res.cloudinary.com/diikggow7/image/upload/v1773829501/statements/statements/resna_1773829500868_1_lg_finovest.png.png" 
               alt="Finovest Logo" style="width: 130px; max-width: 80%; height: auto; display:block; margin:0 auto 10px"; class="logo" />
